...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let numberElem = arr.reduce((counter) => {
    counter++;
    return counter;
  }, 0)
  return numberElem;
...
const returnNames = (arr) => {
  // Solution code here...
  let nameOnly = arr.reduce((acc, person) => {
    acc.name(arr.name);
    return acc;
  }, [])
  return nameOnly;
...
const reversedString = (arr) => {
  // Solution code here...
  let splitter = arr.split('');
  let reverser = splitter.reduce((newStr, current) => {
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let children = characters.reduce((acc, curr) => {
